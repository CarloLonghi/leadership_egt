...
# Output: heatmap plot of the fraction of cooperators as a function of pF and r, for different M
    ...
    nr=3
    nc=3
    f,axs=plt.subplots(nrows=nr, ncols=nc, sharex='all', sharey='all', figsize=(10,10))
    ...
    plt.legend(handles=patches, loc='upper center', bbox_to_anchor=(-0.7 , -0.5),
...
#cb=f.colorbar(h, fraction=0.1,format='%.2f')
    ...
    f.savefig('./newtests/summary_multi_sd_singleleader.png',bbox_inches='tight',dpi=300)
    #plt.show()
    f.clf()     
    return
