...
from mechanics_singleleader.heterogeneous16 import calcH, calcWCD
...
# Output: heatmap plot of the fraction of cooperators as a function of pF and r, for different M
    ...
    f.savefig(f'newtests/4bits/singleleader/aggregates_strategies_r{r}_lead.png',bbox_inches='tight',dpi=300)
    #plt.show()
    return
...
####### Plot heatmap #########################################
    ...
    labfilenpy='./newtests/4bits/singleleader/singlestrat'
