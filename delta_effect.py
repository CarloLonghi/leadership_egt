...
from mechanics_singleleader.noleadermodel4 import calcWCD as calcWCDnoleader
...
# Output: matrix with the fraction of cooperators as a function of pF and r
    ...
    MAT = np.zeros((len(rv), 2, len(deltav) + 1, len(pSv), 4))
...
####### Plot heatmap #########################################
    ...
    labfilenpy='results/h4/cl/res_4strats_M0_f0_deltaeffect'
    MAT=coop_pF_r(rv,M,N,Z,beta,eps,pSv,deltav,f,betaF)
